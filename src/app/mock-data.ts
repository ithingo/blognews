...
export const USERARRAY: UserType[] = [
  {
    id: 1,
    username: 'hillary89',
    email: 'president.h.clinton@usa.com',
    password: 'damn_russians',
    photo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Hillary_Clinton_Testimony_to_House_Select_Committee_on_Benghazi_%281%29.png/200px-Hillary_Clinton_Testimony_to_House_Select_Committee_on_Benghazi_%281%29.png',
    fullName: 'Hillary Clinton',
  },
  {
    id: 2,
    username: 'trumptrumptrump',
    email: 'trump@trump.trump',
    password: 'croocked_hillary',
    photo: 'https://ly.usembassy.gov/wp-content/uploads/sites/246/16114538_1227645557304882_4439457132240667293_n-1.jpg',
    fullName: 'Donald J. Trump',
  },
  {
    id: 3,
    username: 'melisandre@ashai.com',
    email: 'melisandre@ashai.com',
    password: 'lord_of_the_light',
    photo: 'https://www.telegraph.co.uk/content/dam/tv/2016/04/25/melisandre_trans_NvBQzQNjv4BqutubNGxeqbD0m2XylzINLiOoem_3qpp9C-iKHR23jxY.jpg?imwidth=1400',
    fullName: 'Melisandre',
  },
  {
    id: 4,
    username: 'jon.snow@night_watch.westeros',
    email: 'jon.snow@night_watch.westeros',
    password: 'iggrid',
    photo: 'https://pmctvline2.files.wordpress.com/2016/02/game-of-thrones-jon-snow.jpg',
    fullName: 'Jon Snow',
  },
  {
    id: 5,
    ...
    password: 'hades_best',
    photo: 'https://ohmy.disney.com/wp-content/uploads/2014/05/Reasons-We-Cant-Help-but-Love-Hades-Fiery.png',
    fullName: 'Hades',
  },
];
